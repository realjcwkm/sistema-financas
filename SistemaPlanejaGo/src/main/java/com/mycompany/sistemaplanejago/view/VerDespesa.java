...
public class VerDespesa extends javax.swing.JDialog {
    ...
    //Despesa
    public VerDespesa(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public VerDespesa(java.awt.Frame parent, boolean modal, Lancamento lancamento) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(parent);
    ...
    private void popularCamposComLancamento() {
        if (lancamentoAtual != null) {
            ...
            ComboBoxStatus.addItem("Não Paga");
            ComboBoxStatus.addItem("Paga");
            if (lancamentoAtual.isStatusPago()) {
            ...
            try {
                ...
                CentroCusto centroCusto = centroCustoDAO.buscarCentroCustoPorId(lancamentoAtual.getCentroCusto());
                if (centroCusto != null) {
            ...
            if (lancamentoAtual.getDataVencimento() != null) {
                fieldDataVencimento.setText(lancamentoAtual.getDataVencimento().format(DATE_FORMATTER));
            } else {
    ...
    public void setModoVisualizacao() {
        ...
        ComboBoxCentralCusto.setEnabled(false);
        fieldDataCriacao.setEditable(false);
        fieldDataVencimento.setEditable(false);
    ...
    private void carregarComboBoxCentroCusto(boolean isViewingMode) {
        try {
            CentroCustoDAO centroCustoDAO = new CentroCustoDAO();
    ...
    private void initComponents() {
        ...
        labelTitulo.setText("Visualizar Despesa");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VerDespesa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VerDespesa dialog = new VerDespesa(new javax.swing.JFrame(), true);
